...
public class TypingRaceGUI extends JFrame
{
  ...
  private boolean autocorrectEnabled=false;
  private boolean caffeineEnabled = false;
  private boolean nightshiftEnabled=false;
  ...
  private boolean[] symbolTaken=new boolean[6];
  private boolean[] ColourTaken= new boolean[6];
  private String[] typistSymbols=new String[6];
  private boolean[] wristSupport=new boolean[6];
  private boolean[]energyDrink= new boolean[6];
  private Color[] typistColours= new Color[6];
  private double[] typistAccuracies= new double[6];
  private int[] selectedColourIndex = new int[6];
 private ArrayList<Integer>burnouts= new ArrayList<>();
  private ArrayList<Integer>mistypes= new ArrayList<>();
   private ArrayList<Integer>correctOnes= new ArrayList<>();
 private ArrayList<Double>pbs= new ArrayList<>();
  private long start;
  private double[] earnings= new double[6];
  private int[] winsInaRow= new int[6];
  private int[] noBurnoutStreak= new int[6];
  private String[] sponsors={"KeyCorp","TypeMaster","SpeedKeys","FingerFlex","KeyBlaze","RapidType"};
    ...
    public void HomePage()
    {
      ...
      gridPanel.add(difficultyModifier);
       ...
       JLabel imageLabel= imageException("Part2/wallpaper.jpg"); 
    ...
    public static JLabel imageException(String path) 
    {
  ...
  public JPanel BackToHome(JFrame f, JPanel bottom)
  {
  ...
  public JPanel Title(JPanel TitlePanel, String title)
  {
  ...
  public void CustomiseTypists(int PlayerNum)
  {
  ...
  public JTextArea setTextArea(JTextArea a)
  {
        a.setEditable(false);
        a.setOpaque(false);
        a.setLineWrap(true);
  ...
  public JPanel AddtoColumn(JPanel p, JLabel title, JRadioButton one, JRadioButton two, JTextArea desc1, JTextArea desc2)
  {
    ...
    public JPanel AddtoColumn2(JPanel p, JLabel title, JCheckBox one, JCheckBox two, JLabel desc1, JLabel desc2)
  {
     p.add(Box.createVerticalStrut(10));
     p.add(title);
  ...
  public void Stats(Typist[]typists, int turns, int winnerIndex)
  {
