...
public class Typist
{
    ...
    private String typistSymbol; //symbol
    private String typistName;//name
    private double typistAccuracy; // accuracy
    private int burnoutTurnsRemaining;  // turns during burnout
    private int progress; // how far along the passage
    private boolean burnout; //burnout or not
    ...
    public Typist(String typistSymbol, String typistName, double typistAccuracy)
    {
         ...
         progress=0; //set progress to the start
         burnout=false;
    ...
    {
        return burnout; // placeholder - replace with correct implementation
    }
